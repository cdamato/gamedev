...
void add_checkbox(entity e, engine& g, entity parent, point<f32> pos, size<f32> grid_size, u32 index, bool state, std::string label);
void initialize_checkbox_group(entity e, entity parent, engine& g, u32 num_checkboxes);
